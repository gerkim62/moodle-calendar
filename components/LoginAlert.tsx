...
const LoginAlert = async ({}: Props) => {
  ...
  >
    ...
    <div>
      <span className="font-medium">Hey! </span>You are not logged in. <><Link href="/signin" className="text-blue-600 hover:underline">Login here</Link></>
    </div>
  </div>
  }
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Info</span>
      <div>
        <span className="font-medium">Hey! </span>You are logged in as{" "}
